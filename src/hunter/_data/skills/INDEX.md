...
5. User skills live in `~/.hunter/skills/<name>/SKILL.md` with the same frontmatter and optional `tags:`; `quarantined: true` keeps a skill unmounted. User skills shadow bundled names with an auditable note, and every skill is inert data — never execute scripts.
