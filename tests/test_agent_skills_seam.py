...
def test_skill_selector_extension_point_mounts_custom_block(monkeypatch, tmp_path):
    ...
    # Inert by default: the default path IS load_skills_index(). An earlier
    # test may have left the M5 default selector installed globally — clear
    # it first so this measures the property, not test ordering.
